By running `docker-compose up`, you will have you own name servers. If you are not using it in your localhost, please change variable apiUrl in appActions.js to your new DNS name.
